...
static unsigned char s_pRestart0	[]	= "Restart SoniMan-Cobra-ODE?";
...
static unsigned char s_pErrNoMemWeb	[]	= "Not enough memory to launch web browser!\n\nPlease restart SoniMan-Cobra-ODE and try again.";
static unsigned char s_pErrNoMem	[]	= "Please restart SoniMan-Cobra-ODE from PS3 XMB\xE2\x84\xA2";

//SoniMan-Cobra-ODE Update
static unsigned char s_pPleaseWait	[]	= "Please wait...";
static unsigned char s_pWhatsNew	[]	= "What's new in SoniMan-Cobra-ODE %s:\n\n%s";
...
static unsigned char s_pMMUpdateL2	[]	= "SoniMan-Cobra-ODE is being updated constantly, so make sure";
...
static unsigned char s_pMMRefreshL2	[]	= "Force SoniMan-Cobra-ODE to refresh and re-detect content";
...
static unsigned char s_pMMShowtimeSTL1	[]	= "Quit SoniMan-Cobra-ODE and launch Showtime Player.";
...
static unsigned char s_pMMShowtimeLKL3	[]	= "to find them. When linking completes, SoniMan-Cobra-ODE";
...
static unsigned char s_pMMScrSaveL1	[]	= "Turn on SoniMan-Cobra-ODE's screensaver.";
...
static unsigned char s_pMMRestartL1	[]	= "Restart SoniMan-Cobra-ODE. Shortcut is START+SELECT.";
static unsigned char s_pMMRestartL2	[]	= "You can remotely restart SoniMan-Cobra-ODE by connecting to your";
...
static unsigned char s_pMMSetup		[]	= "SoniMan-Cobra-ODE Setup";
static unsigned char s_pMMSetupL1	[]	= "Switch to XMMB Settings column.";
static unsigned char s_pMMSetupL2	[]	= "You can edit all SoniMan-Cobra-ODE options in XMMB mode.";
...
static unsigned char s_pMMQuitL1	[]	= "Quit SoniMan-Cobra-ODE and return to XMB\xE2\x84\xA2 home screen.";
static unsigned char s_pMMQuitL2	[]	= "You can remotely quit SoniMan-Cobra-ODE by connecting to your";
...
static unsigned char s_pMMHelpL3	[]	= "help.MME application and quit SoniMan-Cobra-ODE.";
...
// XMMB Column names ("Empty", "SoniMan-Cobra-ODE", ... Retro, ...)
...
static unsigned char s_pPS2			[]	= "SoniMan-Cobra-ODE will now exit to XMB\xE2\x84\xA2 and you can start the game from the [PLAYSTATION\xC2\xAE\x32 Format Game] icon.";
...
static unsigned char s_pDLST		[]	= "Showtime for SoniMan-Cobra-ODE application is missing!\n\nDo you want to download it now?";

static unsigned char s_pStartBD1	[]	= "SoniMan-Cobra-ODE will now exit to XMB\xE2\x84\xA2 and you can start the game from the /app_home icon.";
static unsigned char s_pStartBD2	[]	= "SoniMan-Cobra-ODE will now exit to XMB\xE2\x84\xA2 and you can start the game from the Blu-ray\xE2\x84\xA2 Game Disc icon.";

static unsigned char s_pOverwrite	[]	= "Destination already contains folder with the same name!\n\nContinue and overwrite?\n\n[%s]";

static unsigned char s_pIncomplete	[]	= "WARNING:\n\nYour installation of SoniMan-Cobra-ODE is incomplete!\nPlease install BASE or FULL version or you may experience graphics display problems!";

static unsigned char s_pErrBDEMU1	[]	= "SoniMan-Cobra-ODE cannot enable selected BD-ROM emulator type. Functionality may be restricted!\n\nError: BDEMU.BIN incorrect version";
static unsigned char s_pErrBDEMU2	[]	= "SoniMan-Cobra-ODE cannot enable BD-ROM emulator. Functionality may be restricted!\n\nError: BDEMU.BIN missing";
static unsigned char s_pErrBDEMU3	[]	= "SoniMan-Cobra-ODE cannot enable BD-ROM emulator. Functionality may be restricted!\n\nError: Unsupported system firmware or BDEMU.BIN incorrect version";

static unsigned char s_pCritical	[]	= "CRITICAL ERROR:\n\nSoniMan-Cobra-ODE cannot access or create default backup folder!\nGame backup functions may not work properly.\n\nPlease use different payload if necessary!";
...
static unsigned char s_pXCUP1		[]	= "Check for SoniMan-Cobra-ODE updates";
...
static unsigned char s_pXCTH1		[]	= "Change SoniMan-Cobra-ODE appearance";
...
static unsigned char s_pXCRS1		[]	= "Close and restart SoniMan-Cobra-ODE";
static unsigned char s_pXCQT		[]	= "Quit";
static unsigned char s_pXCQT1		[]	= "Quit SoniMan-Cobra-ODE and return to XMB\xE2\x84\xA2 screen";
...
static unsigned char s_pXC2IL1		[]	= "Changes SoniMan-Cobra-ODE interface language.";
...
static unsigned char s_pXC2_401	[]	= "Locks SoniMan-Cobra-ODE to pre-selected display mode.";
...
static unsigned char s_pXC9_457	[]	= "Browse Sony Store Website ";

static unsigned char s_pXC9_458	[]	= "Download Themes";
static unsigned char s_pXC9_459	[]	= "Check for new downloadable themes";

static unsigned char s_pXC9_460	[]	= "Visit GameSonic Forum";
static unsigned char s_pXC9_461	[]	= "Browse GameSonic thread for SoniMan-Cobra-ODE discussions";

static unsigned char s_pXC9_462	[]	= "View Online User Guide";
static unsigned char s_pXC9_463	[]	= "Browse to GBATemp website for beginner's guide to SoniMan-Cobra-ODE";

static unsigned char s_pXC9_464	[]	= "Support SoniMan-Cobra-ODE Development";
static unsigned char s_pXC9_465	[]	= "Find how to contribute to SoniMan-Cobra-ODE development";
...
static unsigned char s_pXC1_RSPS32	[]	= "Close SoniMan-Cobra-ODE and restart your PLAYSTATION\xC2\xAE\x33 System";
